...
Student_VO student = dao.getStudentInformation("201910823");
%>
<%
		...
		<div class="contents">
			<section class="nav-contents">
				<div div class="contents-info show">
					...
					<%
					String action = "/Project_NCP/Scholar_Evaluation?action=Evelment_&student=" + student.getUniversity_number();
								...
								<table>
									...
									<tr>
										...
										<td><input class="Scolar_Evauation" name="check_1"
											value=<%=i %> type="checkbox" onclick="checkOnly(this,this.name)"></td>
										<%} %>
									</tr>
									<tr>
